...
class AlphaVelocity:
    ...
    def calculate_price_momentum(self, hist_data):
        ...
        if len(hist_data) < 248:  # Need at least 1 year of data
            return 0
...
##        'USAR', 'MP', 'ALB', 'FCX', 'SCCO',
##        'REMX', 'LIT',
##        'UI', 'IRM', 'NOW', 'WELL', 'ARKK'
##    ]

    ai_stocks = [
        'NVDA', 'TSM', 'ASML', 'AVGO', 'MSFT', 'META', 'GOOGL', 'AMZN', 'AAPL',
        'VRT', 'MOD', 'BE', 'CIEN', 'ATKR', 'UI',
        'SRVR', 'DLR', 'EQIX',
        'COR', 'IRM'
        ]
