...
- [x] Add CSRF protection for state-changing endpoints *(2026-02-10)*
...
- [x] Remove duplicate code in portfolio services *(2026-02-12)*
- [x] Consolidate API response formatting *(2026-02-13)*
