...
try:
    from .portfolio_watchlist import router as portfolio_watchlist_router
    api_router.include_router(portfolio_watchlist_router, prefix="/user/portfolios", tags=["watchlist"])
except ImportError:
    pass
